...
def parse_args():
    ...
    parser.add_argument("--data", type=str, default="D:/project/train/train/test_small/data.yaml",
    ...
    parser.add_argument("--imgsz", type=int, default=210, help="输入图片大小 (默认640x640)")
